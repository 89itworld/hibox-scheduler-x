  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta property="og:image" content="https://hibox.co/video-og-image.png" />
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:image" content="https://hibox.co/video-og-image.png" />
      </Head>
      <div style={{ zIndex: 2, position: "relative" }}>
        <Link href="/">
          <img
            className="fixed z-10 hidden h-5 w-auto sm:inline-block"
            src="https://hibox.co/logo-white.svg"
            alt="Hibox.co Logo"
            style={{
              top: 46,
              left: 24,
