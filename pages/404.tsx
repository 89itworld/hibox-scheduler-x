  ...
  const links = [
    {
      ...
      href: "https://docs.hibox.co",
    },
    {
      title: t("blog"),
      description: t("blog_description"),
      icon: BookOpenIcon,
      href: "https://hibox.co/blog",
    },
  ];

  const isSubpage = router.asPath.includes("/", 2);
  const isSignup = router.asPath.includes("/signup");
  const isCalcom = process.env.NEXT_PUBLIC_BASE_URL === "https://app.hibox.co";
  const signupLink = "https://hibox.co/signup?username=" + username.replace("/", "");
    ...
    <>
      ...
      <div className="min-h-screen bg-white px-4">
        <main className="mx-auto max-w-xl pt-16 pb-6 sm:pt-24">
          {isSignup && process.env.NEXT_PUBLIC_BASE_URL !== "https://app.hibox.co" ? (
            <div>
              <div>
              ...
              <div className="mt-12">
                ...
                <ul role="list" className="mt-4">
                  <li className="border-2 border-green-500 px-4 py-2">
                    <a
                      href="https://hibox.co/pricing?infra"
                ...
                <ul role="list" className="divide-y divide-gray-200 border-gray-200">
                  <li className="px-4 py-2">
                    <Link href="https://docs.hibox.co/self-hosting/install#setting-up-your-first-user">
                ...
                <div className="mt-8">
                  <Link href="https://hibox.co/enterprise">
                ...
                {isSubpage ? (
                  ...
                  <Link href={signupLink}>
                    <a className="mt-2 inline-block text-lg">
                      {t("the_username")} <strong className="text-blue-500">hibox.co{username}</strong>{" "}
