...
export default function LicenseBanner() {
  ...
  /*
    ...
    LICENSE: https://github.com/calcom/hibox.co/blob/main/LICENSE

    Summary of terms:
    - The codebase has to stay open source, whether it was modified or not
    - You can not repackage or sell the codebase
    - Acquire a commercial license to remove these terms by emailing: license@hibox.co
    ...
    return (
      <ConfirmationDialogContent
        ...
        <ul className="ml-5 list-disc">
          ...
          <li>
            {t("acquire_license")}:{" "}
            <a className="text-blue-500 underline" href="mailto:license@hibox.co">
              license@hibox.co
            </a>
          </li>
        </ul>
