<!-- PROJECT LOGO -->
<p align="center">
  <a href="https://github.com/calcom/hibox.co">
    <img src="https://user-images.githubusercontent.com/8019099/133430653-24422d2a-3c8d-4052-9ad6-0580597151ee.png" alt="Logo">

  </a>

  <h3 align="center">Hibox.co (formerly hibox)</h3>

  <p align="center">
    The open-source Calendly alternative.
    <br />
    <a href="https://hibox.co"><strong>Learn more »</strong></a>
    <br />
    <br />
    <a href="https://hibox.co/slack">Slack</a>
    ·
    <a href="https://hibox.co">Website</a>
    ·
    <a href="https://github.com/calcom/hibox.co/issues">Issues</a>
  </p>
</p>

<p align="center">
   <a href="https://hibox.co/slack"><img src="https://img.shields.io/badge/Slack-hibox.slack.com-%234A154B" alt="Join Hibox.co Slack"></a>
   <a href="https://www.producthunt.com/posts/hibox"><img src="https://img.shields.io/badge/Product%20Hunt-%231%20Product%20of%20the%20Month-%23DA552E" alt="Product Hunt"></a>
  <a href="https://github.com/calcom/hibox.co/stargazers"><img src="https://img.shields.io/github/stars/calcom/hibox.co" alt="Github Stars"></a>
  ...
  <a href="https://github.com/calcom/hibox.co/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-AGPLv3-purple" alt="License"></a>
  <img src="https://img.shields.io/github/package-json/v/calcom/hibox.co">
  <a href="https://github.com/calcom/hibox.co/pulse"><img src="https://img.shields.io/github/commit-activity/m/calcom/hibox.co" alt="Commits-per-month"></a>
  <a href="https://hibox.co/pricing"><img src="https://img.shields.io/badge/Pricing-%2412%2Fmonth-brightgreen" alt="Pricing"></a>
  <a href="https://jitsu.com?utm_source=github/calcom/hibox.co"><img src="https://img.shields.io/badge/Metrics_tracked_by-JITSU-AA00FF?logo=data:image/png;base64," alt="Jitsu Tracked"></a>
...
That's where Hibox.co comes in. Self-hosted or hosted by us. White-label by design. API-driven and ready to be deployed on your own domain. Full control of your events and data.

## Product of the Month: April

#### Support us on [Product Hunt](https://www.producthunt.com/posts/hibox?utm_source=badge-top-post-badge&utm_medium=badge&utm_souce=badge-hibox)

<a href="https://www.producthunt.com/posts/hibox?utm_source=badge-top-post-badge&utm_medium=badge&utm_souce=badge-hibox" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/top-post-badge.svg?post_id=291910&theme=light&period=monthly" alt="Hibox.co - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a> <a href="https://www.producthunt.com/posts/hibox?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-hibox" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=291910&theme=light" alt="Hibox.co - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a> <a href="https://www.producthunt.com/stories/how-this-open-source-calendly-alternative-rocketed-to-product-of-the-day" target="_blank"><img src="https://hibox.co/maker-grant.svg" alt="Hibox.co - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a>
...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/calcom/hibox.co.git
   ```
...
1. Configure environment variables in the .env file. Replace `<user>`, `<pass>`, `<db-host>`, `<db-port>` with their applicable values
   ...
   7. In `Settings`, copy your URI to your Hibox.co .env file and replace the `postgresql://<user>:<pass>@<db-host>:<db-port>` with it.
...
The Docker configuration for Cal is an effort powered by people within the community. Hibox.co, Inc. does not provide official support for Docker, but we will accept fixes and documentation. Use at your own risk.
...
<a href="https://heroku.com/deploy?template=https://github.com/calcom/hibox.co">
  <img width="185px" height="auto" src="https://www.herokucdn.com/deploy/button.svg" alt="Deploy">
</a>

### Railway

[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/new/template?template=https%3A%2F%2Fgithub.com%2Fhibox%2Fhibox&plugins=postgresql&envs=GOOGLE_API_CREDENTIALS%2CBASE_URL%2CNEXTAUTH_URL%2CPORT&BASE_URLDefault=http%3A%2F%2Flocalhost%3A3000&NEXTAUTH_URLDefault=http%3A%2F%2Flocalhost%3A3000&PORTDefault=3000)

You can deploy Cal on [Railway](https://railway.app/) using the button above. The team at Railway also have a [detailed blog post](https://blog.railway.app/p/hibox) on deploying Cal on their platform.

<!-- ROADMAP -->

## Roadmap

See the [open issues](https://github.com/calcom/hibox.co/issues) for a list of proposed features (and known issues).
...
9. Under Authorized redirect URI's, select Add URI and then add the URI `<Hibox.co URL>/api/integrations/googlecalendar/callback` replacing Hibox.co URL with the URI at which your application runs.
...
4. Set the **Web** redirect URI to `<Hibox.co URL>/api/integrations/office365calendar/callback` replacing Hibox.co URL with the URI at which your application runs.
...
9. Set the Redirect URL for OAuth `<Hibox.co URL>/api/integrations/zoomvideo/callback` replacing Hibox.co URL with the URI at which your application runs.
...
12. Click "Done".
13. You're good to go. Now you can easily add your Zoom integration in the Hibox.co settings.
...
Special thanks to these amazing projects which help power Hibox.co:

[<img src="https://hibox.co/powered-by-vercel.svg">](https://vercel.com/?utm_source=calend-so&utm_campaign=oss)
...
[<img src="https://jitsu.com/img/powered-by-jitsu.png?gh=true">](https://jitsu.com/?utm_source=hibox.co-gihub)

Hibox.co is an [open startup](https://jitsu.com) and [Jitsu](https://github.com/jitsucom/jitsu) (an open-source Segment alternative) helps us to track most of the usage metrics.
