                        ...
                        <tr>
                          <td align="left" vertical-align="middle" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                              <tr>
                                <td align="center" bgcolor="#8F6CC8" role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#292929;" valign="middle">
                          ...
                          <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Roboto, Helvetica, sans-serif;font-size:16px;font-weight:500;line-height:1;text-align:left;color:#3E3E3E;">
                              ...
                              <div style="line-height: 6px;">
                                <p style="font-weight: 400; line-height: 24px;">${this.passwordEvent.language(
                                  "have_any_questions"
                                )} <a href="mailto:support@hibox.co" style="color: #3E3E3E" target="_blank">${this.passwordEvent.language(
      "contact_our_support_team"
    )}</a></p>
                              </div>
                            </div>
