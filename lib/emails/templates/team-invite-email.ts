...
export default class TeamInviteEmail {
  ...
  protected getNodeMailerPayload(): Record<string, unknown> {
    return {
      ...
      from: `Hibox.co <${this.getMailerOptions().from}>`,
                        ...
                        <tr>
                          <td align="left" vertical-align="middle" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                              <tr>
                                <td align="center" bgcolor="#8F6CC8" role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#8F6CC8;" valign="middle">
                                  <p style="display:inline-block;background:#8F6CC8;color:#8F6CC8;font-family:Roboto, Helvetica, sans-serif;font-size:13px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:3px;">
                                    <a href="${
                          ...
                          <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Roboto, Helvetica, sans-serif;font-size:16px;font-weight:500;line-height:1;text-align:left;color:#3E3E3E;">
                              <div style="line-height: 6px;">
                                <p style="font-weight: 400; line-height: 24px;">${this.teamInviteEvent.language(
                                  "have_any_questions"
                                )} <a href="mailto:support@hibox.co" style="color: #3E3E3E" target="_blank">${this.teamInviteEvent.language(
